package br.udc.edu.sistemas.ia6.servlet;
...
import br.udc.edu.sistemas.ia6.controller.Controller;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if ((action != null) && (!action.equals("")) &&
				...
				Class <?> controllerClass = Class.forName("br.udc.edu.sistemas.ia6.controller.Controller" + entityName);
